...
- The only valid measurement of code quality: [WTFs/minute](https://blog.codinghorror.com/whos-your-coding-buddy/)
...
Please use [Naming Guidelines](./Naming%20Guidelines.md) document. 
...
Please use [Unit Tests Guidelines](./Unit%20Tests%20Guideline.md) for unit tests.
